    ...
    <asp:Panel ID="Panel1" runat="server" style="background-color: #CCCCCC">
        <table class="auto-style1">
            <tr>
                ...
                <td class="auto-style10">MESAJ LİSTESİ</td>
            </tr>
        </table>
    </asp:Panel>
                        ...
                        <table class="auto-style1">
                            <tr>
                                <td class="auto-style2" style="text-align: left">
                                    <asp:Label ID="Label1" runat="server" CssClass="auto-style4" style="text-align: left" Text='<%# Eval("MesajGonderen") %>'></asp:Label>
                                </td>
                                <td class="auto-style3">
                               <a href="MesajDetay.aspx?MesajId=<%#Eval("MesajId") %>">  <asp:Image ID="Image3" runat="server" Height="30px" ImageUrl="~/İkonlar/read.png" Width="30px" /></a> 
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
